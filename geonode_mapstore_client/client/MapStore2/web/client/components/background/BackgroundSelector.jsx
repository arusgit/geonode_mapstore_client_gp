...
class BackgroundSelector extends React.Component {
    ...
    getIcons = (side, frame, margin, vertical, backgrounds) => {
        return this.props.enabled ? backgrounds.map((layer, idx) => {
                ...
                >
                    {this.props.mode !== 'mobile' &&
                        <div
                            ...
                            {this.props.mapIsEditable && this.props.allowDeletion && backgrounds.length > 1 && <ToolbarButton
                                glyph="trash"
    ...
    renderBackgroundSelector = () => {
        ...
        // Filter out the layer named "Cesium World Terrain"
        const filteredBackgrounds = this.props.backgrounds.filter(background => background.type !== 'terrain');
        ...
        const icons = this.getIcons(side, frame, margin, configuration.vertical, filteredBackgrounds);
